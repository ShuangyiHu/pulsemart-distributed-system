...
class OutboxPublisherTest {
    ...
    void publishPendingEvents_shouldMarkEventAsSentAfterSuccessfulKafkaSend() {
        OutboxEvent event = pendingEvent("PAYMENT_SUCCEEDED");
    ...
    void publishPendingEvents_shouldMarkAsFailedAfterMaxRetries() {
        OutboxEvent event = pendingEvent("PAYMENT_FAILED");
    ...
    @Test
    void publishPendingEvents_shouldPublishToPaymentEventsTopic() {
        OutboxEvent succeeded = pendingEvent("PAYMENT_SUCCEEDED");
        OutboxEvent failed = pendingEvent("PAYMENT_FAILED");
    ...
    void publishPendingEvents_shouldProcessEventsIndependently() {
        OutboxEvent good = pendingEvent("PAYMENT_SUCCEEDED");
        OutboxEvent bad = pendingEvent("PAYMENT_FAILED");
